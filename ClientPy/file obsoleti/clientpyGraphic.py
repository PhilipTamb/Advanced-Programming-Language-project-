...
class Login:
    def __init__(self,root):
        ...
        btn_register = Button(window,  text="Sign In", command=self.registration_function, font=("times new roman", 20), bd=0, cursor="hand2").place(x=320, y=480)
        btn_page = Button(window,  text="Sign Up", command=login_page, font=("times new roman", 20), bd=0, cursor="hand2").place(x=220, y=480)
