...
class Register:
    def __init__(self, root):
        ...
        footer_name = Label(footer, text="Created & Developed By Saad Ahmed Salim",
                            font=("comic sans ms", 25, "bold"), bg="gray", fg="#ECF0F1").place(x=70, y=12)
        ...
        btn_register = Button(frame1, bd=0, cursor="hand2", command=self.register_data).place(x=50, y=490)
