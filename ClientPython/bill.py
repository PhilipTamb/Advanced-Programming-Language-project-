...
#Upload 
    try:
        ...
        print("Errore nell'apertura della fattura")
...
# insert db 
    ...
    credentials = { 
                ...
                'path': "http://localhost:8080/fatture/" + nome_pdf  
                 } #"http://localhost/fatture/" questa riga va cambiata in base alle specifiche del server
    response = requests.post(url, data=credentials, headers=headers)
